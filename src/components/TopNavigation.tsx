  ...
  return (
    <nav className="fixed w-full z-30 top-4 flex justify-center">
      <div className="max-w-[800px] w-full mx-4">
        <div className="bg-white dark:bg-gray-800/95 border border-gray-100 dark:border-gray-700/50 rounded-full relative backdrop-blur-lg">
          <div className="flex items-center justify-between h-12 px-6">
            ...
            <div className="flex items-center gap-3">
              <div className="relative">
                ...
                <Input 
                  placeholder="Search..." 
                  className="pl-7 w-40 h-8 bg-gray-50/50 dark:bg-gray-700/50 text-sm rounded-full border-gray-200 dark:border-gray-600 dark:text-gray-300 dark:placeholder:text-gray-500"
                />
              </div>
              <button className="p-1.5 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700/50">
