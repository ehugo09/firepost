...
const NetworksCard = () => {
  ...
  if (loading) {
    return (
      <Card className="p-2 h-full bg-white/80 dark:bg-[#151B2E]/80 backdrop-blur-lg">
  ...
  return (
    <Card className="p-2 h-full bg-white/80 dark:bg-[#151B2E]/80 backdrop-blur-lg border-gray-200/50 dark:border-gray-700/50">
